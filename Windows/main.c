...
/*   Updated: 2025/01/23 06:40:21 by hmateque         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
    ...
    Maquina *maquina_enchimento_PA = criarMaquina("Enchimento PA", "enchimento", 2000);
    Maquina *maquina_enchimento_PB = criarMaquina("Enchimento PB", "enchimento", 3000);
    Maquina *maquina_embalamento_PA = criarMaquina("Embalamento PA", "embalamento", 5000);
    Maquina *maquina_embalamento_PB = criarMaquina("Embalamento PB", "embalamento", 4000);
